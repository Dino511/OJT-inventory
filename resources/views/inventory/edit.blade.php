    ...
    <div class="mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-1">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit #{{ $inventory->id }}</li>
            </ol>
        </nav>
        <h3 class="fw-bold mb-0">Edit Inventory Record</h3>
    </div>
        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white p-3 border-bottom">
                    <span class="fw-semibold text-secondary small text-uppercase">Edit Inventory Details</span>
                </div>
